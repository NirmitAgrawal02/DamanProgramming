...
ass_variable(t_ass_variable_bool(Tid,Tbval)) --> ['bool'],identifier(Tid),['='],boolean_value(Tbval).
ass_variable(t_ass_variable_st(Tid,Tstr)) --> ['st'],identifier(Tid),['='],boolean_value(Tstr).
